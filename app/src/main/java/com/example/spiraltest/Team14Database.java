...
public class Team14Database {

    //singleton object
    private static final Team14Database db;
    static{
        db = new Team14Database();
    }
    ...
    public static Team14Database getInstance(){ return db; }
     ...
     * @param preferences
     */
    public void initialize(SharedPreferences preferences, ContextWrapper context){
        prefs = preferences;
        active1 = true;
    ...
    public void addSpiralTest(Team14SpiralHelper t){
        if(isActive()) {
...
/**
 ...
 return sb.toString();
    ...
    public class DataStore{
        private ArrayList<Team14SpiralHelper> spiralStore;
        ...
        public ArrayList<Team14SpiralHelper> getSpiralStore(){
            return spiralStore;
        }
