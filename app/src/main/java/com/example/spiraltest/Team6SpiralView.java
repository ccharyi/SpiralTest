...
public class Team6SpiralView extends View {
    ...
    public Team6SpiralView(Context context) {
        super(context);
        init(null, 0);
    }

    public Team6SpiralView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public Team6SpiralView(Context context, AttributeSet attrs, int defStyleAttr) {
                ...
                countdown = new CountDownTimer(5000, 100) {
                    ...
                    public void onFinish() {
                        if(up){
                            ...
                            AlertDialog builder;
                            builder = new AlertDialog.Builder((Team6)getContext()).create();
