...
public class Team7Trace extends AppCompatActivity {

    private Chronometer timer;
    private Button start_button;
    private Button stop_button;

    private Team7DrawView draw_event;
...
//    private long right_h_time = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team7_trace);
        if (ContextCompat.checkSelfPermission(Team7Trace.this,
                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(Team7Trace.this,
                    android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                ActivityCompat.requestPermissions(Team7Trace.this,
        ...
        draw_event = (Team7DrawView) findViewById(R.id.trace_draw_view);
