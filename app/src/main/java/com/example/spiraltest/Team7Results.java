...
public class Team7Results extends Activity {
    TextView leftHand;
    TextView rightHand;
    Button homeButton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team7_results);

        String result = getIntent().getStringExtra(getString(R.string.team7_LEFT));
        ...
        result = getIntent().getStringExtra(getString(R.string.team7_RIGHT));
        result = result.substring(0,Math.min(5,result.length()));
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Team7Results.this, MainActivity.class);
