...
public class Team7DrawView extends View {
    ...
    public Team7DrawView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Team7DrawView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public Team7DrawView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
